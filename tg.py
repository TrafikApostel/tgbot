...
def start_main():
    ...
    'ищу дизайнера',
    'графический дизайн']
    anti_keys = ['создаю продающий дизайн','#помогу','портфолио в лс','скидка','делаю за отзыв','делаю инфограф','резюме, портфолио','портфолио, резюме','cоздаю инфографику','cоздам дизайн']
    msgs = []
