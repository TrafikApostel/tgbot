...
def start_main():
    ...
    'ищу дизайнера',
    'графический дизайн']
    anti_keys = ['ищу заказчиков','помогу','создам для вас','сделаю круто и быстро','портфолио в описании','портфолио в профиле','делаю дизайн','я графический','я дизайнер','создаю продающий дизайн','#помогу','портфолио в лс','скидка','делаю за отзыв','делаю инфограф','резюме, портфолио','портфолио, резюме','cоздаю инфографику','cоздам дизайн']
    msgs = []
